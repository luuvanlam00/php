...
if (@$_POST['nlpayment']) {
	...
	if ($_SESSION['giohang']) {
		...
		$k = "select * from khachhang";
		$kh = mysqli_query($link, $k);
	...
	<form name="NLpayBank" action="#" method="post">
		<table style="clear:both;width:500px;padding-left:46px;">
			...
			<tr>
				...
				<td>
					<input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?php echo $tien ?>" readonly>
				</td>
			</tr>
			<tr>
				<td>Họ Tên: </td>
				<td>
					<input type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="<?php echo $ten ?>" readonly>
				</td>
			</tr>
			<tr>
				<td>Email: </td>
				<td>
					<input type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="<?php echo $email ?>" readonly>
				</td>
			</tr>
			<tr>
				<td>Số Điện thoại: </td>
				<td>
					<input type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="<?php echo $sdt ?>" readonly>
				</td>
			</tr>
		</table>
