               ...
               <div class="row">
                  ...
                  ?>
                     <div class="col-md-3 col-sm-6">
                        <div class="products">
                           <div class="offer">- <?php  if($r['giakm']>0) echo ceil(($r['giaban'] - $r['giakm']) * 100 / $r['giaban']) ?>%</div>
            ...
            <li>
               <div class="row">
                  ...
                  ?>
                     <div class="col-md-3 col-sm-6">
                        <div class="products">
                           <div class="offer">- <?php if($r2['giakm'] > 0) echo ceil(($r2['giaban'] - $r2['giakm']) * 100 / $r2['giaban']) ?>%</div>
