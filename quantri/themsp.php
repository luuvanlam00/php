...
<div class="ibox-content">
    ...
    <form method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group"><label class="col-sm-2 control-label">Ảnh sản phẩm</label>
            ...
            <div class="col-sm-10"><input type="file" class="form-control" name="anh_sp" id="imgInp"/>
        ...
        <div class="form-group"><label class="col-sm-2 control-label">Giá bán </label>
            ...
            <div class="col-sm-10"><input type="number" step="0.01"required="" class="form-control" name="gb"/></div>
        </div>
        <div class="form-group"><label class="col-sm-2 control-label">Giá khuyến mại</label>

            <div class="col-sm-10"><input type="number" step="0.01" required="" class="form-control" name="gkm"/></div>
        </div>
        <div class="hr-line-dashed"></div>
